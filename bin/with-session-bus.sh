...
# SOURCE: https://github.com/freedesktop/telepathy-salut/blob/8ad4fd8cd6f2f59fea168311324a98e2af1a8c7f/tests/twisted/tools/with-session-bus.sh
# SOURCE: https://github.com/GNOME/telepathy-account-widgets/blob/33a299b29e8e381b96bdfb0e448e244207415a0f/tools/with-session-bus.sh
